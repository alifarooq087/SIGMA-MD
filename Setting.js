...
global.owner = process.env.OWNER_NUMBER  || '923006586907' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "923156598103" ;          // DON'T REMOVE
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'FAROOQ AHMAD S',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `FAROOQ AHMAD S`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '03006586907',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "FAROOQ AHMAD S" ,          // ADD YOUR STICKER PACKNAME
  ...
  caption :process.env.CAPTION || "FAROOQ AHMAD S",
  LANG: process.env.THEME || "03006586907",
